...
struct Channel {
	...
	async::result<void>
	commonIoctl(Process *process, managarm::fs::CntRequest req, helix::UniqueLane conversation);
...
async::result<void>
MasterFile::ioctl(Process *process, managarm::fs::CntRequest req, helix::UniqueLane conversation) {
...
async::result<void>
SlaveFile::ioctl(Process *process, managarm::fs::CntRequest req, helix::UniqueLane conversation) {
