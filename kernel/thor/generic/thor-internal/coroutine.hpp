...
struct coroutine {
	...
	struct promise_type {
		...
		auto final_suspend() noexcept {
			struct awaiter {
				...
				void
				await_suspend(std::experimental::coroutine_handle<void>) noexcept {
	...
	coroutine(std::experimental::coroutine_handle<promise_type> h) : h_ { h } {}
...
requires(std::is_same_v<last_type_t<Args...>, enable_detached_coroutine>) struct coroutine_traits<
        void,
        Args...> {
...
requires(std::is_same_v<
         last_type_t<Args...>,
         enable_detached_coroutine>) struct coroutine_traits<void, X, Args...> {
	using promise_type = detached_coroutine_promise;
};
}  // namespace std::experimental
