...
inline static frg::array<frg::string_view, 12> dtGicCompatible = {
	"arm,arm11mp-gic",   "arm,cortex-a15-gic",   "arm,cortex-a7-gic",  "arm,cortex-a5-gic",
	"arm,cortex-a9-gic", "arm,eb11mp-gic",       "arm,gic-400",        "arm,pl390",
	"arm,tc11mp-gic",    "nvidia,tegra210-agic", "qcom,msm-8660-qgic", "qcom,msm-qgic2"
};

inline static frg::array<frg::string_view, 3> dtPciCompatible = { "pci-host-cam-generic",
